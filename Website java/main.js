...
document.getElementById('formdata').innerHTML=JSON.parse(localStorage.getItem('formdata101'));
...
{localStorage.setItem('formdata101','You havent filled out the form yet!');
...
'<b style="margin-left:400px;">date modified: </b>'+startformdate2+"<br><br>"+
...
"<b>Ability and Achievements: </b>"+formability3;
document.getElementById('formdata').style.lineHeight='30px';
}

function formreviewdown()
{
if(document.getElementById('formdata').innerHTML=="You havent filled out the form yet!")
return false;
else
...
"<b>Bachelor grade: </b>"+formedu33+"<br>"+
"<b>Ability and Achievements: </b>"+formability3;
localStorage.setItem('formdata101',JSON.stringify(formdata10000));
}
